...
`C4C` - Constitutional Principles And Public Policy Explanation And Application

## Purpose

This package defines a decomposition node extending `C4` for the social studies domain.

It operationalizes the learner's ability to explain and apply constitutional principles and public policy.
