...
`Q2A` - Compare Classify And Sequence Evidence Foundations And Examples

## Purpose

This package defines a decomposition node extending `Q2` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within compare classify and sequence evidence.
