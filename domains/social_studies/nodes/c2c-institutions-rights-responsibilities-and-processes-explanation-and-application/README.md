...
`C2C` - Institutions Rights Responsibilities And Processes Explanation And Application

## Purpose

This package defines a decomposition node extending `C2` for the social studies domain.

It operationalizes the learner's ability to explain and apply institutions rights responsibilities and processes.
