...
`E4B` - Markets Labor And Public Resource Decisions Classification And Organization

## Purpose

This package defines a decomposition node extending `E4` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of markets labor and public resource decisions.
