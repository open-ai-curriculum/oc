...
`C5B` - Comparative Government And Civic Action Classification And Organization

## Purpose

This package defines a decomposition node extending `C5` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of comparative government and civic action.
