...
`C3A` - Civic Decision Making And Deliberation Foundations And Examples

## Purpose

This package defines a decomposition node extending `C3` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within civic decision making and deliberation.
