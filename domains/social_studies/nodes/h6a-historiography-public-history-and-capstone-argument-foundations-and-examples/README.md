...
`H6A` - Historiography Public History And Capstone Argument Foundations And Examples

## Purpose

This package defines a decomposition node extending `H6` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within historiography public history and capstone argument.
