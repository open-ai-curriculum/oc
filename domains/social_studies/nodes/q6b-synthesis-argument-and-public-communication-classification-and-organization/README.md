...
`Q6B` - Synthesis Argument And Public Communication Classification And Organization

## Purpose

This package defines a decomposition node extending `Q6` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of synthesis argument and public communication.
