...
`C2A` - Institutions Rights Responsibilities And Processes Foundations And Examples

## Purpose

This package defines a decomposition node extending `C2` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within institutions rights responsibilities and processes.
