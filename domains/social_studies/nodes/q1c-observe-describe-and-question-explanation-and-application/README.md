...
`Q1C` - Observe Describe And Question Explanation And Application

## Purpose

This package defines a decomposition node extending `Q1` for the social studies domain.

It operationalizes the learner's ability to explain and apply observe describe and question.
