...
`C1A` - Community Rules Roles And Fairness Foundations And Examples

## Purpose

This package defines a decomposition node extending `C1` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within community rules roles and fairness.
