...
`C4B` - Constitutional Principles And Public Policy Classification And Organization

## Purpose

This package defines a decomposition node extending `C4` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of constitutional principles and public policy.
