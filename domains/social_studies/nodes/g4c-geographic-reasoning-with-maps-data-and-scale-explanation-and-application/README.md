...
`G4C` - Geographic Reasoning With Maps Data And Scale Explanation And Application

## Purpose

This package defines a decomposition node extending `G4` for the social studies domain.

It operationalizes the learner's ability to explain and apply geographic reasoning with maps data and scale.
