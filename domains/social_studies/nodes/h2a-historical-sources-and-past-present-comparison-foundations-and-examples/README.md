...
`H2A` - Historical Sources And Past Present Comparison Foundations And Examples

## Purpose

This package defines a decomposition node extending `H2` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within historical sources and past present comparison.
