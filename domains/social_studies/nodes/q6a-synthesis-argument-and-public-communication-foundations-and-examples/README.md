...
`Q6A` - Synthesis Argument And Public Communication Foundations And Examples

## Purpose

This package defines a decomposition node extending `Q6` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within synthesis argument and public communication.
