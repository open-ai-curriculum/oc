...
`E2B` - Production Consumption And Local Markets Classification And Organization

## Purpose

This package defines a decomposition node extending `E2` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of production consumption and local markets.
