...
`H4A` - Sourcing Corroboration And Historical Argument Foundations And Examples

## Purpose

This package defines a decomposition node extending `H4` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within sourcing corroboration and historical argument.
