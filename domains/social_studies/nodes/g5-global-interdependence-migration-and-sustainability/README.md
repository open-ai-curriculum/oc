...
`G5` - Global interdependence, migration, and sustainability

## Purpose

This package defines the next geography node for the social studies domain.

It operationalizes the learner's ability to explain migration, interdependence, and sustainability pressures across scales using geographic evidence.
