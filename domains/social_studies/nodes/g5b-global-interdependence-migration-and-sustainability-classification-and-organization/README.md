...
`G5B` - Global Interdependence Migration And Sustainability Classification And Organization

## Purpose

This package defines a decomposition node extending `G5` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of global interdependence migration and sustainability.
