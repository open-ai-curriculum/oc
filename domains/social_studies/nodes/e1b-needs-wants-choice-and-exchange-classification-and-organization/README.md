...
`E1B` - Needs Wants Choice And Exchange Classification And Organization

## Purpose

This package defines a decomposition node extending `E1` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of needs wants choice and exchange.
