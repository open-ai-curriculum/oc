...
`G6B` - Geospatial Analysis And Policy Application Classification And Organization

## Purpose

This package defines a decomposition node extending `G6` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of geospatial analysis and policy application.
