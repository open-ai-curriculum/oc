...
`H3A` - Causation Context And Change Over Time Foundations And Examples

## Purpose

This package defines a decomposition node extending `H3` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within causation context and change over time.
