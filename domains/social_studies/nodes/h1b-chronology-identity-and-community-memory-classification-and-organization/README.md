...
`H1B` - Chronology Identity And Community Memory Classification And Organization

## Purpose

This package defines a decomposition node extending `H1` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of chronology identity and community memory.
