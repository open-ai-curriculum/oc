# Q2 Verification Model

## Gate Set

### G1. Direct Performance Gate

- purpose: compare classify and sequence evidence
- pass rule: at least 85% accuracy across node-aligned tasks

### G2. Meaning Gate

- purpose: explain the rule used for grouping or ordering
- pass rule: usable explanation in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: apply the same comparison or sequencing logic to a changed source type
