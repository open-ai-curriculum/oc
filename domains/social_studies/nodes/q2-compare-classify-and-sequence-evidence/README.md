...
This package defines the second inquiry node for the social studies domain.

It operationalizes the learner's ability to compare features, group evidence into usable categories, and order evidence in sequence before later explanation and investigation work begins.
