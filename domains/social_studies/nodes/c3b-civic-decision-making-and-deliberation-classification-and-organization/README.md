...
`C3B` - Civic Decision Making And Deliberation Classification And Organization

## Purpose

This package defines a decomposition node extending `C3` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of civic decision making and deliberation.
