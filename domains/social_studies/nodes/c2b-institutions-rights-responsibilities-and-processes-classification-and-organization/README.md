...
`C2B` - Institutions Rights Responsibilities And Processes Classification And Organization

## Purpose

This package defines a decomposition node extending `C2` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of institutions rights responsibilities and processes.
