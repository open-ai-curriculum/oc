...
`H4B` - Sourcing Corroboration And Historical Argument Classification And Organization

## Purpose

This package defines a decomposition node extending `H4` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of sourcing corroboration and historical argument.
