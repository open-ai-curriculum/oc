...
`C6D` - Advanced Civic Argument Policy Design And Participation Transfer And Contextual Use

## Purpose

This package defines a decomposition node extending `C6` for the social studies domain.

It operationalizes the learner's ability to transfer and adapt advanced civic argument policy design and participation.
