...
`Q5B` - Evaluation Of Sources Models And Claims Classification And Organization

## Purpose

This package defines a decomposition node extending `Q5` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of evaluation of sources models and claims.
