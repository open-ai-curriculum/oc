...
`C5A` - Comparative Government And Civic Action Foundations And Examples

## Purpose

This package defines a decomposition node extending `C5` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within comparative government and civic action.
