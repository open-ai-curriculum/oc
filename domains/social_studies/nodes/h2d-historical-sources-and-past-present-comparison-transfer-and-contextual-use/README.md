...
`H2D` - Historical Sources And Past Present Comparison Transfer And Contextual Use

## Purpose

This package defines a decomposition node extending `H2` for the social studies domain.

It operationalizes the learner's ability to transfer and adapt historical sources and past present comparison.
