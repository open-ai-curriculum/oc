...
`A1C` - Interdisciplinary Research And Evidence Synthesis Explanation And Application

## Purpose

This package defines a decomposition node extending `A1` for the social studies domain.

It operationalizes the learner's ability to explain and apply interdisciplinary research and evidence synthesis.
