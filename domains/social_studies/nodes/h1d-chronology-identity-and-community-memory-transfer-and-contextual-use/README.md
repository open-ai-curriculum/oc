...
`H1D` - Chronology Identity And Community Memory Transfer And Contextual Use

## Purpose

This package defines a decomposition node extending `H1` for the social studies domain.

It operationalizes the learner's ability to transfer and adapt chronology identity and community memory.
