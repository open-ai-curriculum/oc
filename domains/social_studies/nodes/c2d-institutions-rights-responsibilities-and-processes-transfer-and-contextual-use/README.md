...
`C2D` - Institutions Rights Responsibilities And Processes Transfer And Contextual Use

## Purpose

This package defines a decomposition node extending `C2` for the social studies domain.

It operationalizes the learner's ability to transfer and adapt institutions rights responsibilities and processes.
