...
`A2C` - Capstone Argument Modeling And Public Communication Explanation And Application

## Purpose

This package defines a decomposition node extending `A2` for the social studies domain.

It operationalizes the learner's ability to explain and apply capstone argument modeling and public communication.
