...
`H5B` - Thematic Historical Analysis And Periodization Classification And Organization

## Purpose

This package defines a decomposition node extending `H5` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of thematic historical analysis and periodization.
