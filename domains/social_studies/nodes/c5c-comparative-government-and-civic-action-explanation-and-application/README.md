...
`C5C` - Comparative Government And Civic Action Explanation And Application

## Purpose

This package defines a decomposition node extending `C5` for the social studies domain.

It operationalizes the learner's ability to explain and apply comparative government and civic action.
