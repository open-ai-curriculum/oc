...
`E1A` - Needs Wants Choice And Exchange Foundations And Examples

## Purpose

This package defines a decomposition node extending `E1` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within needs wants choice and exchange.
