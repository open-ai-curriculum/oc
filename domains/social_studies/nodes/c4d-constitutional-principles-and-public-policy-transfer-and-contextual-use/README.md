...
`C4D` - Constitutional Principles And Public Policy Transfer And Contextual Use

## Purpose

This package defines a decomposition node extending `C4` for the social studies domain.

It operationalizes the learner's ability to transfer and adapt constitutional principles and public policy.
