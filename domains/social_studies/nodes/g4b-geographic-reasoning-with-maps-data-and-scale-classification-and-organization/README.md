...
`G4B` - Geographic Reasoning With Maps Data And Scale Classification And Organization

## Purpose

This package defines a decomposition node extending `G4` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of geographic reasoning with maps data and scale.
