...
`H4` - Sourcing, corroboration, and historical argument

## Purpose

This package defines the next history node for the social studies domain.

It operationalizes the learner's ability to source historical evidence, corroborate across accounts, and form a bounded historical argument.
