...
`C3C` - Civic Decision Making And Deliberation Explanation And Application

## Purpose

This package defines a decomposition node extending `C3` for the social studies domain.

It operationalizes the learner's ability to explain and apply civic decision making and deliberation.
