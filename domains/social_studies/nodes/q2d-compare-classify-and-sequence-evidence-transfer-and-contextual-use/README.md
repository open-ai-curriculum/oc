...
`Q2D` - Compare Classify And Sequence Evidence Transfer And Contextual Use

## Purpose

This package defines a decomposition node extending `Q2` for the social studies domain.

It operationalizes the learner's ability to transfer and adapt compare classify and sequence evidence.
