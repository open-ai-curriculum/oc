...
`G3C` - Spatial Patterns Movement And Resources Explanation And Application

## Purpose

This package defines a decomposition node extending `G3` for the social studies domain.

It operationalizes the learner's ability to explain and apply spatial patterns movement and resources.
