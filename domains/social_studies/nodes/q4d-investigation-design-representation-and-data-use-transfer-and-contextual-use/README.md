...
`Q4D` - Investigation Design Representation And Data Use Transfer And Contextual Use

## Purpose

This package defines a decomposition node extending `Q4` for the social studies domain.

It operationalizes the learner's ability to transfer and adapt investigation design representation and data use.
