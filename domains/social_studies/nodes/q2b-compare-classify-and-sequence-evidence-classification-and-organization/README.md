...
`Q2B` - Compare Classify And Sequence Evidence Classification And Organization

## Purpose

This package defines a decomposition node extending `Q2` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of compare classify and sequence evidence.
