...
`Q5D` - Evaluation Of Sources Models And Claims Transfer And Contextual Use

## Purpose

This package defines a decomposition node extending `Q5` for the social studies domain.

It operationalizes the learner's ability to transfer and adapt evaluation of sources models and claims.
