...
`Q5C` - Evaluation Of Sources Models And Claims Explanation And Application

## Purpose

This package defines a decomposition node extending `Q5` for the social studies domain.

It operationalizes the learner's ability to explain and apply evaluation of sources models and claims.
