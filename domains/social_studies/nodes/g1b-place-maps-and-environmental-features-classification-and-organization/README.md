...
`G1B` - Place Maps And Environmental Features Classification And Organization

## Purpose

This package defines a decomposition node extending `G1` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of place maps and environmental features.
