...
`Q3C` - Supported Explanation From Evidence Explanation And Application

## Purpose

This package defines a decomposition node extending `Q3` for the social studies domain.

It operationalizes the learner's ability to explain and apply supported explanation from evidence.
