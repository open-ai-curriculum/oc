...
`C6B` - Advanced Civic Argument Policy Design And Participation Classification And Organization

## Purpose

This package defines a decomposition node extending `C6` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of advanced civic argument policy design and participation.
