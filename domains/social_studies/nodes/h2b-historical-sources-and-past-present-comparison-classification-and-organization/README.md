...
`H2B` - Historical Sources And Past Present Comparison Classification And Organization

## Purpose

This package defines a decomposition node extending `H2` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of historical sources and past present comparison.
