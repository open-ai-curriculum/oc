...
`Q1D` - Observe Describe And Question Transfer And Contextual Use

## Purpose

This package defines a decomposition node extending `Q1` for the social studies domain.

It operationalizes the learner's ability to transfer and adapt observe describe and question.
