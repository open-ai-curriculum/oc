...
`C5D` - Comparative Government And Civic Action Transfer And Contextual Use

## Purpose

This package defines a decomposition node extending `C5` for the social studies domain.

It operationalizes the learner's ability to transfer and adapt comparative government and civic action.
