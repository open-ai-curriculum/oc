...
`Q2C` - Compare Classify And Sequence Evidence Explanation And Application

## Purpose

This package defines a decomposition node extending `Q2` for the social studies domain.

It operationalizes the learner's ability to explain and apply compare classify and sequence evidence.
