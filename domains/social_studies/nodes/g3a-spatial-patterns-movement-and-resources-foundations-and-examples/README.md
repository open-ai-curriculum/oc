...
`G3A` - Spatial Patterns Movement And Resources Foundations And Examples

## Purpose

This package defines a decomposition node extending `G3` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within spatial patterns movement and resources.
