...
`C4A` - Constitutional Principles And Public Policy Foundations And Examples

## Purpose

This package defines a decomposition node extending `C4` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within constitutional principles and public policy.
