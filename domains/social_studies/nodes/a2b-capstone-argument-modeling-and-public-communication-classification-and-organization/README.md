...
`A2B` - Capstone Argument Modeling And Public Communication Classification And Organization

## Purpose

This package defines a decomposition node extending `A2` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of capstone argument modeling and public communication.
