...
`H3B` - Causation Context And Change Over Time Classification And Organization

## Purpose

This package defines a decomposition node extending `H3` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of causation context and change over time.
