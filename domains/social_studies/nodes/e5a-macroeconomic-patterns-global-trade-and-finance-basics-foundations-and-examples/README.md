...
`E5A` - Macroeconomic Patterns Global Trade And Finance Basics Foundations And Examples

## Purpose

This package defines a decomposition node extending `E5` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within macroeconomic patterns global trade and finance basics.
