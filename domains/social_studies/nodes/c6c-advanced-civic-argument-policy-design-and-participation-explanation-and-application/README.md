...
`C6C` - Advanced Civic Argument Policy Design And Participation Explanation And Application

## Purpose

This package defines a decomposition node extending `C6` for the social studies domain.

It operationalizes the learner's ability to explain and apply advanced civic argument policy design and participation.
