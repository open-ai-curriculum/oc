...
`C1B` - Community Rules Roles And Fairness Classification And Organization

## Purpose

This package defines a decomposition node extending `C1` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of community rules roles and fairness.
