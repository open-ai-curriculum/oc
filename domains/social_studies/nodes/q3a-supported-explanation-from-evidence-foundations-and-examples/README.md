...
`Q3A` - Supported Explanation From Evidence Foundations And Examples

## Purpose

This package defines a decomposition node extending `Q3` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within supported explanation from evidence.
