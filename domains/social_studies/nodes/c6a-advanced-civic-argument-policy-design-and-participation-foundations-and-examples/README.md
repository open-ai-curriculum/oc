...
`C6A` - Advanced Civic Argument Policy Design And Participation Foundations And Examples

## Purpose

This package defines a decomposition node extending `C6` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within advanced civic argument policy design and participation.
