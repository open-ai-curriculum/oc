...
`G5A` - Global Interdependence Migration And Sustainability Foundations And Examples

## Purpose

This package defines a decomposition node extending `G5` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within global interdependence migration and sustainability.
