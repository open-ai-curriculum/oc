...
`E5B` - Macroeconomic Patterns Global Trade And Finance Basics Classification And Organization

## Purpose

This package defines a decomposition node extending `E5` for the social studies domain.

It operationalizes the learner's ability to organize compare and classify elements of macroeconomic patterns global trade and finance basics.
