...
`G2A` - Human Environment Interaction And Regions Foundations And Examples

## Purpose

This package defines a decomposition node extending `G2` for the social studies domain.

It operationalizes the learner's ability to build foundational recognition and guided examples within human environment interaction and regions.
