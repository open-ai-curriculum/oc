# Social Studies Parity Checklist

## Purpose

Provide a concrete parity checklist against the mathematics domain so social studies parity can be assessed explicitly rather than inferred.

## Checklist

| Parity area | Current status | Notes |
| --- | --- | --- |
| K-12 domain topology exists | Complete | Canonical graph, spine, and node packages exist |
| Node-count parity with mathematics | Complete | `146` node packages |
...
| Assessment overlays exist | Complete | `7` AP-facing overlays implemented |
| Gephi export exists | Complete | Generated |
| Neo4j export exists | Complete | Generated |
| Unified operational graph export exists | Complete | Generated |
| Multiple artifact registries exist | Complete | entry, systems, and capstone registries exist |
| Multiple runtime slices exist | Complete | entry, systems, and capstone runtime slices exist |
| Cross-domain runtime guidance exists | Complete | capstone routing guide and examples added |
| Focused graph-cut packages exist | Complete | Bounded inquiry-to-explanation and disciplinary peer-graph packages now exist in md/yaml form |
| Assessment-specific graph cuts exist | Complete | Focused graph packages now exist for every maintained AP-facing social studies overlay family in md/yaml form |
| Upstream build plan exists | Complete | Added in this wave |
| Downstream expansion plan exists | Complete | Added in this wave |
| Cross-branch integration audit exists | Complete | Added in this wave |
| External assessment coverage scan exists | Complete | Added in this wave |
