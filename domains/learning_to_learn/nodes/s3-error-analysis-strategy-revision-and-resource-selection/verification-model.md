# S3 Verification Model

## Gate Set

### G1. Direct Performance Gate

- purpose: confirm error analysis revision and resource choice
- pass rule: error analysis strategy revision and resource selection in at least 4 of 5 structured opportunities

### G2. Transfer Gate

- purpose: confirm revision and resource choice across changed tasks
- pass rule: one successful changed-context revision cycle
