# C4 Verification Model

## Verification Gates

`C4` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across refactoring, maintainability, and collaborative code change tasks.
2. Meaning gate: learner explains the targeted maintainability and collaboration reasoning ideas in at least `2` of `3` prompts.
