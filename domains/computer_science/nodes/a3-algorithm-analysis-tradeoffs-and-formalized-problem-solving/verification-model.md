# A3 Verification Model

## Verification Gates

`A3` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across algorithm analysis, tradeoffs, and formalized problem solving tasks.
2. Meaning gate: learner explains the targeted algorithm analysis reasoning ideas in at least `2` of `3` prompts.
