...
1. Direct performance gate: learner reaches at least `0.90` accuracy across specification, testing, and program quality criteria tasks.
2. Meaning gate: learner explains the targeted software quality reasoning ideas in at least `2` of `3` prompts.
