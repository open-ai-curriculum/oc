# P4 Verification Model

## Verification Gates

`P4` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across functions, modular program design, and abstraction boundaries tasks.
2. Meaning gate: learner explains the targeted modular program design reasoning ideas in at least `2` of `3` prompts.
