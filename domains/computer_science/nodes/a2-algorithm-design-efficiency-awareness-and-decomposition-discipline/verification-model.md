# A2 Verification Model

## Verification Gates

`A2` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across algorithm design, efficiency awareness, and decomposition discipline tasks.
2. Meaning gate: learner explains the targeted algorithm design reasoning ideas in at least `2` of `3` prompts.
