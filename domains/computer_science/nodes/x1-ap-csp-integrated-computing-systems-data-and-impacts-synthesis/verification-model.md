# X1 Verification Model

## Verification Gates

`X1` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across ap csp integrated computing systems, data, and impacts synthesis tasks.
2. Meaning gate: learner explains the targeted integrated AP CSP reasoning ideas in at least `2` of `3` prompts.
