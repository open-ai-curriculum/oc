# N2 Verification Model

## Verification Gates

`N2` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across network pathways, protocol ideas, and system dependence tasks.
2. Meaning gate: learner explains the targeted network pathway reasoning ideas in at least `2` of `3` prompts.
