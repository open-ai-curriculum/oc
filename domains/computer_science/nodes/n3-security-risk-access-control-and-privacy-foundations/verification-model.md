# N3 Verification Model

## Verification Gates

`N3` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across security risk, access control, and privacy foundations tasks.
2. Meaning gate: learner explains the targeted security and privacy reasoning ideas in at least `2` of `3` prompts.
