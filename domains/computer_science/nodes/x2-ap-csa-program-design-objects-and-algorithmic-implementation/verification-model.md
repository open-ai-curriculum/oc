# X2 Verification Model

## Verification Gates

`X2` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across ap csa program design, objects, and algorithmic implementation tasks.
2. Meaning gate: learner explains the targeted integrated AP CSA reasoning ideas in at least `2` of `3` prompts.
