...
1. Direct performance gate: learner reaches at least `0.90` accuracy across data transformation, tables, and computational models tasks.
2. Meaning gate: learner explains the targeted computational data reasoning ideas in at least `2` of `3` prompts.
