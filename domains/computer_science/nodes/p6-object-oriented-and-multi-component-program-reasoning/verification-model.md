# P6 Verification Model

## Verification Gates

`P6` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across object-oriented and multi-component program reasoning tasks.
2. Meaning gate: learner explains the targeted multi-component software reasoning ideas in at least `2` of `3` prompts.
