# I4 Verification Model

## Verification Gates

`I4` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across ethics, governance, and societal consequences of computing systems tasks.
2. Meaning gate: learner explains the targeted computing ethics and governance reasoning ideas in at least `2` of `3` prompts.
