# I3 Verification Model

## Verification Gates

`I3` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across computing impacts, bias, and human-centered evaluation tasks.
2. Meaning gate: learner explains the targeted computing impacts reasoning ideas in at least `2` of `3` prompts.
