# P5 Verification Model

## Verification Gates

`P5` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across structured data, collections, and programmed data operations tasks.
2. Meaning gate: learner explains the targeted programmed data-structure reasoning ideas in at least `2` of `3` prompts.
