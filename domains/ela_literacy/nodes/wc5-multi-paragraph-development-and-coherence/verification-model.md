...
- pass rule: produces coherent multi-paragraph writing with sustained development in at least 5 of 6 supported opportunities

### G2. Meaning Gate

- purpose: confirm the learner demonstrates the intended meaning relationship rather than routine success alone
- pass rule: cross-paragraph meaning and organization remain coherent in at least 4 of 5 prompts

### G3. Transfer Gate

- purpose: confirm the learner can carry the target into a changed text or task surface
- pass rule: succeeds across at least one changed topic, structure, or multi-paragraph task
