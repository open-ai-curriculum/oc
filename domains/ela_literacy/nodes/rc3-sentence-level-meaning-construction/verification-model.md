...
- pass rule: answers sentence-level meaning prompts accurately in at least 5 of 6 supported opportunities

### G2. Meaning Gate

- purpose: confirm that the learner demonstrates the intended meaning relationship rather than routine success alone
- pass rule: paraphrases or otherwise demonstrates sentence meaning in at least 4 of 5 prompts

### G3. Transfer Gate

- purpose: confirm the learner can carry the target into a changed text or task surface
- pass rule: succeeds across at least one changed sentence frame, syntax pattern, or support surface
