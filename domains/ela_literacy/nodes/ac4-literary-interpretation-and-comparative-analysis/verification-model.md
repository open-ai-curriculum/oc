...
- pass rule: develops sustained literary interpretation and comparative analysis in at least 5 of 6 supported opportunities

### G2. Meaning Gate

- purpose: confirm the learner demonstrates the intended meaning relationship rather than routine success alone
- pass rule: interpretation remains coherent, comparative, and text-grounded in at least 4 of 5 prompts

### G3. Transfer Gate

- purpose: confirm the learner can carry the target into a changed text or task surface
- pass rule: succeeds across at least one changed literary text set or comparative task
