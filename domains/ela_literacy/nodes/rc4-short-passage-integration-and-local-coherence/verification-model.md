...
- pass rule: answers short-passage integration prompts accurately in at least 5 of 6 supported opportunities

### G2. Meaning Gate

- purpose: confirm that the learner demonstrates the intended meaning relationship rather than routine success alone
- pass rule: explains the local relation between sentences or details in at least 4 of 5 prompts

### G3. Transfer Gate

- purpose: confirm the learner can carry the target into a changed text or task surface
- pass rule: succeeds across at least one changed short passage, layout, or prompt type
