...
- pass rule: synthesizes multiple sources into a coherent research-based response in at least 5 of 6 supported opportunities

### G2. Meaning Gate

- purpose: confirm the learner demonstrates the intended meaning relationship rather than routine success alone
- pass rule: source integration and synthesis remain coherent and relevant in at least 4 of 5 prompts

### G3. Transfer Gate

- purpose: confirm the learner can carry the target into a changed text or task surface
- pass rule: succeeds across at least one changed source set or research question
