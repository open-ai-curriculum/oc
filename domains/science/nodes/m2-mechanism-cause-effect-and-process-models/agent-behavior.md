# M2 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `M2`.
...
- flag dependency instability in `M1` or `E1`
...
1. identify whether the breakdown is in process order, cause-effect, mechanism, or transfer
...
- language structure or sequencing demands may be masking stronger reasoning
- an unusual mechanism explanation may still be defensible
