...
`I3` - Repeated trials, data reliability, and pattern summary

## Purpose

This package defines the learner's ability to use repeated trials, judge simple data reliability, and summarize patterns across investigation results.
