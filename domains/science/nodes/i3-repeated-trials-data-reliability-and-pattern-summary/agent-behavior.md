# I3 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `I3`.
...
- flag dependency instability in `I2`
...
1. identify whether the breakdown is in valuing repetition, judging reliability, pattern summary, or transfer
...
- numeric or table-reading demands may be masking stronger investigation reasoning
- an alternative summary may still be defensible from the data
