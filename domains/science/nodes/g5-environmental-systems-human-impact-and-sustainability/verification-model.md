# G5 Verification Model

## Verification Gates

`G5` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across environmental systems, human impact, and sustainability tasks.
2. Meaning gate: learner explains the targeted earth and environmental specialization ideas in at least `2` of `3` prompts.
