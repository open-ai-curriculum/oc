# I1 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `I1`.
...
1. identify whether the breakdown is about fairness, tool choice, recording, or transfer
...
- motor access or safety constraints may be confounding performance
- the learner's investigation reasoning is stronger than the response mode captures
