...
- purpose: carry out a simple fair-test and measurement routine
- pass rule: at least 90% accuracy across test-sequencing, tool-use, and recording tasks

### G2. Meaning Gate

- purpose: explain what makes the routine fair and what the tool is for
- pass rule: correct explanation in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: apply the investigation routine in a changed context
