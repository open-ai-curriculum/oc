# E3 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `E3`.
...
- flag dependency instability in `E2` or `M2`
...
1. identify whether the breakdown is in revision, model/source coordination, source quality, or transfer
...
- source-reading or literacy demands may be masking stronger reasoning
- a nonstandard revision may still be evidence-defensible
