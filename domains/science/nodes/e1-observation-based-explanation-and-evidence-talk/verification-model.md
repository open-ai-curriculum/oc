# E1 Verification Model

## Gate Set

### G1. Direct Performance Gate

- purpose: make a simple explanation and support it with direct evidence
- pass rule: at least 90% accuracy across claim, evidence, and explanation tasks

### G2. Meaning Gate

- purpose: explain why a named observation counts as evidence
- pass rule: correct explanation in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: use the same evidence talk in a changed phenomenon context
