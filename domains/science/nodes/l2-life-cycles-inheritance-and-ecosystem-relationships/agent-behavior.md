...
Define the allowed role of agents when working on `L2`.
...
- flag dependency instability in `L1` or `M1`
...
1. identify whether the breakdown is in life-cycle ordering, trait sharing, ecosystem relationships, or transfer
...
- local ecological familiarity may be affecting interpretation
- language expression may be masking stronger life-science reasoning
