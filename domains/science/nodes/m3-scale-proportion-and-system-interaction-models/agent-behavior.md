# M3 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `M3`.
...
- flag dependency instability in `M2` or `I2`
...
1. identify whether the breakdown is in scale, relative change, interactions, or transfer
...
- abstraction or representation demands may be masking stronger reasoning
- a nonstandard system model may still be scientifically meaningful
