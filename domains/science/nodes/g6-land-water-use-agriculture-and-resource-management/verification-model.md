# G6 Verification Model

## Verification Gates

`G6` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across land/water use, agriculture, and resource management tasks.
