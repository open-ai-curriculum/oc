# G1 Verification Model

## Verification Gates

`G1` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across geology, geophysics, and surface process systems tasks.
