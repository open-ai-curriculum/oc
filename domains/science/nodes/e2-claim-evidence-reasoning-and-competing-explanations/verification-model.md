# E2 Verification Model

## Gate Set

### G1. Direct Performance Gate

- purpose: build claim-evidence-reasoning responses and compare explanations
- pass rule: at least 90% accuracy across CER and competing-explanation tasks

### G2. Meaning Gate

- purpose: explain why one explanation is better supported by the evidence
- pass rule: correct explanation in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: use CER in a changed science context
