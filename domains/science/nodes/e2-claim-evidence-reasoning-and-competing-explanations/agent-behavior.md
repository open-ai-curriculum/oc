# E2 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `E2`.
...
- flag dependency instability in `E1` or `I2`
...
1. identify whether the breakdown is in claim-evidence alignment, reasoning, explanation comparison, or transfer
...
- discourse or literacy demands may be masking science reasoning
- a nonstandard explanation may still have defensible evidence support
