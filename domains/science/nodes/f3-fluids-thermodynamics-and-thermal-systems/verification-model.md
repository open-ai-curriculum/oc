# F3 Verification Model

## Verification Gates

`F3` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across fluids, thermodynamics, and thermal systems tasks.
