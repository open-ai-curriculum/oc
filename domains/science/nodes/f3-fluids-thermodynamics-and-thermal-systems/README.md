# F3 Fluids, Thermodynamics, and Thermal Systems

This package defines the governed draft node for advanced secondary physics specialization for fluids, thermodynamics, and thermal systems.
