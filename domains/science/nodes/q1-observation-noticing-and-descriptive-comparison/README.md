...
This package defines the earliest science-entry readiness in the domain.

It operationalizes the learner's ability to notice observable properties, compare what is seen, and describe changes without yet requiring formal investigation design.
