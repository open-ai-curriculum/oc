...
This package defines the earliest physical-science readiness in the domain.

It operationalizes the learner's ability to describe observable material properties, notice motion changes, and explain simple push-pull or contact interactions using direct evidence.
