# P1 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `P1`.
...
1. identify whether the breakdown is about properties, motion change, interaction cause, or evidence discipline
...
- sensory or motor access may be confounding the physical-science signal
- a learner explanation is unusual but potentially valid
