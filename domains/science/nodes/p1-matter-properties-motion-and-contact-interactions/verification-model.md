...
- purpose: identify material properties, motion changes, and contact interactions
- pass rule: at least 90% accuracy across property, motion, and interaction tasks

### G2. Meaning Gate

- purpose: explain which observed property or interaction supports the claim
- pass rule: correct explanation in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: apply the same reasoning to changed objects or motion contexts
