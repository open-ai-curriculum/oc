...
`Q2` - Question formation, prediction language, and pattern noticing

## Purpose

This package defines the learner's early ability to turn observations into bounded science questions, simple predictions, and recurring-pattern statements.
