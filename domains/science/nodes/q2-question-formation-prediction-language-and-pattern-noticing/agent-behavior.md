# Q2 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `Q2`.
...
- flag dependency instability in `Q1`
...
1. identify whether the learner's question or prediction is checkable and on-topic
...
- language formulation may be masking science understanding
- a learner question is unusual but still scientifically valuable
