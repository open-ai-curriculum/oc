# D2 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `D2`.
...
- flag dependency instability in `D1` or `I2`
...
1. identify whether the breakdown is in reading the test, redesigning, noticing tradeoffs, or transfer
...
- motor or building demands may be masking stronger design reasoning
- an unconventional redesign may still fit the evidence
