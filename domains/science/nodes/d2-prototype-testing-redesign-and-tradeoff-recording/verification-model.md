...
- purpose: test prototypes, redesign, and record tradeoffs
- pass rule: at least 90% accuracy across prototype-testing and redesign tasks

### G2. Meaning Gate

- purpose: explain why a redesign was made and what changed in performance
- pass rule: correct explanation in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: use the same redesign logic in a changed design context
