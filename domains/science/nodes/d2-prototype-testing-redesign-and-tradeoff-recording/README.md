...
`D2` - Prototype testing, redesign, and tradeoff recording

## Purpose

This package defines the learner's ability to test a prototype, record what happened, revise the design, and recognize simple tradeoffs in early engineering contexts.
