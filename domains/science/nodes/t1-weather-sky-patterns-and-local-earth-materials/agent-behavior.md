# T1 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `T1`.
...
- flag dependency instability in `Q1` or `E1`
...
1. identify whether the breakdown is about direct observation, pattern-over-time reasoning, materials comparison, or evidence discipline
...
- local weather context or environment access may be distorting the task signal
- language expression may be masking stronger Earth/space understanding
