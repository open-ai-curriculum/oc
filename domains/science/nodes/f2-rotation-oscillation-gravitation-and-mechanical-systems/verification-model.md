# F2 Verification Model

## Verification Gates

`F2` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across rotation, oscillation, gravitation, and mechanical systems tasks.
2. Meaning gate: learner explains the targeted physics specialization ideas in at least `2` of `3` prompts.
