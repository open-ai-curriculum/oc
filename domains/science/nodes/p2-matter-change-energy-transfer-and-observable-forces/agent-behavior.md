# P2 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `P2`.
...
- flag dependency instability in `P1` or `I1`
...
1. identify whether the breakdown is in matter change, energy evidence, force effects, or transfer
...
- sensory access or tool use may be masking the signal
- a nonstandard explanation may still have evidence support
