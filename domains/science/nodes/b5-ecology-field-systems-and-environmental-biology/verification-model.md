# B5 Verification Model

## Verification Gates

`B5` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across ecology, field systems, and environmental biology tasks.
2. Meaning gate: learner explains the targeted advanced biological specialization ideas in at least `2` of `3` prompts.
