...
`I2` - Variable awareness, data recording, and basic comparison

## Purpose

This package defines the learner's ability to notice what changes in an investigation, record simple data consistently, and compare outcomes without losing track of the focal variable.
