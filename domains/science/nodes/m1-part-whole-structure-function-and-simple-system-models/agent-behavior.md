# M1 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `M1`.
...
- flag dependency instability in `Q3`
...
1. identify whether the breakdown is about parts, model mapping, structure-function, or transfer
...
- drawing or spatial-representation demands may be distorting the signal
- a nonstandard model may still be scientifically meaningful
