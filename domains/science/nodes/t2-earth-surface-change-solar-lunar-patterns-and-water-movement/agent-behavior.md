# T2 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `T2`.
...
- flag dependency instability in `T1` or `I1`
...
1. identify whether the breakdown is in surface change, sky patterns, water movement, or transfer
...
- local environment access or seasonal timing may be shaping the signal
- a nonstandard explanation may still be tied to evidence
