# C3 Verification Model

## Verification Gates

`C3` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across stoichiometry, reaction quantification, and solution chemistry tasks.
2. Meaning gate: learner explains the targeted chemistry specialization ideas in at least `2` of `3` prompts.
