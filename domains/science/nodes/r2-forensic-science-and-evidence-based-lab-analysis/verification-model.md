...
1. Direct performance gate: learner reaches at least `0.90` accuracy across forensic science and evidence-based lab analysis tasks.
2. Meaning gate: learner explains the targeted applied science specialization ideas in at least `2` of `3` prompts.
