# D3 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `D3`.
...
- flag dependency instability in `D2`, `E3`, or `M3`
...
1. identify whether the breakdown is in system failure analysis, tradeoffs, optimization, or transfer
...
- the learner proposes an unconventional but potentially valid system optimization
- abstraction or evidence-integration demands may be masking reasoning
