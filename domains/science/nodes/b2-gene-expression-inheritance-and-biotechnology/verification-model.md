# B2 Verification Model

## Verification Gates

`B2` requires all of the following before `secure` status can be assigned:

1. Direct performance gate: learner reaches at least `0.90` accuracy across gene expression, inheritance, and biotechnology tasks.
