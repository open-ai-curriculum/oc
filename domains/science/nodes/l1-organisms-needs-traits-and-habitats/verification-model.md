...
- purpose: identify organism needs, traits, and habitat relationships
- pass rule: at least 90% accuracy across needs, trait, and habitat tasks

### G2. Meaning Gate

- purpose: explain how the observed trait or habitat feature supports the claim
- pass rule: correct explanation in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: apply the same reasoning in a changed organism or habitat context
