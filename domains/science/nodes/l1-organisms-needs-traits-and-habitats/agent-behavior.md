# L1 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `L1`.
...
1. identify whether the breakdown is about needs, traits, habitat function, or evidence discipline
...
- cultural or local ecological context may affect interpretation
- language expression may be masking stronger life-science understanding
