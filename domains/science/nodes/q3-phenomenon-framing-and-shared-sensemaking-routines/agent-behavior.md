# Q3 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `Q3`.
...
1. identify whether the breakdown is about the focal phenomenon, topic drift, or relevance judgment
...
- discourse norms or language access may be masking science understanding
- a contribution appears off-topic but may be an indirect insight
