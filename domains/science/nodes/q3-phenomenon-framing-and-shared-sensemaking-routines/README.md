...
`Q3` - Phenomenon framing and shared sensemaking routines

## Purpose

This package defines the learner's ability to stay anchored to a focal phenomenon, identify what is being figured out, and participate in shared sensemaking routines without drifting away from the evidence.
