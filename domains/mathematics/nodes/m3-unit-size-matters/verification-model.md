...
- purpose: compare and interpret measurement results when unit size changes
- pass rule: at least 90% accuracy across unit-size tasks

### G2. Meaning Gate

- purpose: explain why unit size affects count
- pass rule: correct explanation in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: handle changed surface forms such as length, area, and partition contexts
