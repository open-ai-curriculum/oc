# F5 Agent Behavior Rules

## Purpose

Define the allowed role of agents when working on `F5`.
...
1. identify the earliest visible structural breakdown
...
- language-access issues may be confounding the math signal
- learner work appears mathematically nonstandard but possibly valid
