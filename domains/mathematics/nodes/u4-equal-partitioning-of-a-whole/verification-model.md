# U4 Verification Model

## Gate Set

### G1. Direct Performance Gate

- purpose: identify or produce equal partitions of a whole
- pass rule: at least 90% accuracy across partitioning tasks

### G2. Meaning Gate

- purpose: explain why equal partitioning matters
- pass rule: correct explanation in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: handle changed surface forms such as shapes, strips, and sharing contexts
