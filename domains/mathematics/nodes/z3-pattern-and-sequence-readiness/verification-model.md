...
- purpose: identify and continue simple patterns and sequences
- pass rule: at least 90% accuracy across pattern and sequence tasks

### G2. Meaning Gate

- purpose: explain what repeats or what comes next
- pass rule: correct explanation in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: handle changed materials such as blocks, pictures, and simple placeholders
