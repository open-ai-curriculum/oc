# AP4 Integral accumulation and Fundamental Theorem

This directory contains the governed node package for `AP4` `integral_accumulation_and_fundamental_theorem`.
