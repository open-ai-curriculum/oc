...
- purpose: measure and compare using repeated equal units
- pass rule: at least 90% accuracy across iterated-unit tasks

### G2. Meaning Gate

- purpose: explain why the same unit must be repeated consistently
- pass rule: correct explanation in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: handle changed surface forms such as length strips, area covers, and object comparison
