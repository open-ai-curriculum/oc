...
- purpose: compose and decompose small numbers reliably
- pass rule: at least 90% accuracy across whole-part tasks

### G2. Meaning Gate

- purpose: explain how parts make a whole and how the same whole can be decomposed differently
- pass rule: correct explanation in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: handle changed surface forms such as counters, drawings, and short stories
