...
- purpose: identify and interpret one equal part correctly
- pass rule: at least 90% accuracy across unit-fraction readiness tasks

### G2. Meaning Gate

- purpose: explain how the number of equal parts determines the size of one part
- pass rule: correct explanation in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: handle changed surface forms such as area models, set models, and sharing contexts
