# U1 Verification Model

## Gate Set

### G1. Direct Performance Gate

- purpose: identify or produce equal groups
- pass rule: at least 90% accuracy across equal-group tasks

### G2. Meaning Gate

- purpose: explain that equal groups have the same number in each group
- pass rule: correct explanation in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: handle changed surface forms such as objects, drawings, and simple grouping stories
