# Z1 Verification Model

## Gate Set

### G1. Direct Performance Gate

- purpose: notice and distinguish broad quantity states
- pass rule: at least 90% accuracy across simple quantity-attention tasks

### G2. Meaning Gate

- purpose: indicate that quantity changed or differs
- pass rule: correct explanation or indication in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: handle changed contexts such as objects, pictures, and everyday quantity situations
