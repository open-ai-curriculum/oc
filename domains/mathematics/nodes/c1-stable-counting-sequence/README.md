...
This package defines the earliest implemented counting foundation in the current spine.

It exists to operationalize the learner's ability to produce the count sequence in stable order within the supported range.
