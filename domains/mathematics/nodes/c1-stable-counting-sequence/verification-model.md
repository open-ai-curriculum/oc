...
- purpose: produce the count sequence in stable order
- pass rule: at least 90% accuracy across sequence tasks

### G2. Meaning Gate

- purpose: explain that the sequence must stay in order
- pass rule: correct explanation in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: handle changed forms such as missing-number, continue-from-here, and start-stop tasks
