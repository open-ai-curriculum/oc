# U2 Verification Model

## Gate Set

### G1. Direct Performance Gate

- purpose: identify and reason about repeated equal units or groups
- pass rule: at least 90% accuracy across repeated-unit tasks

### G2. Meaning Gate

- purpose: explain what makes the groups or units the same
- pass rule: correct explanation in at least 2 of 3 opportunities

### G3. Transfer Gate

- purpose: handle changed surface forms such as object groups, strips, or tiled spaces
