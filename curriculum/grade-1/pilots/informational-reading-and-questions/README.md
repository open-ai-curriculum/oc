# Grade 1 Literacy Pilot: Informational Reading and Questions

## Purpose

This package extends the Grade 1 curriculum layer with an informational-reading unit focused on asking and answering questions, identifying key details, and using text and picture evidence in simple oral and written responses.

## Included Artifacts

- `unit.md`
- `lessons/lesson-01-key-details-in-an-informational-text.md`
- `standards-map.md`
- `review-record.md`
