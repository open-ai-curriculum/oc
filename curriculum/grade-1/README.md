# Grade 1 Curriculum Workspace

## Purpose

This directory contains the first-grade curriculum buildout produced under the repository's spec-driven workflow.

## Current State

The Grade 1 layer is beginning with a literacy-first packet so the repository can validate:

- progression beyond kindergarten literacy routines
- text-dependent comprehension and retell expectations for first grade
- support-material quality at the next grade band

## Draft Grade 1 Progression
