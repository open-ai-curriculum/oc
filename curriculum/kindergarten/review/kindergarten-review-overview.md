# Kindergarten Review Overview

## Purpose

This document gives human reviewers a single orientation for the current kindergarten curriculum layer.
...
- Does the current order make developmental sense?
- Are important prerequisites introduced before dependent work?
...
- Are expectations appropriate for kindergarten learners?
- Are supports developmentally appropriate?
- Do any tasks drift toward first-grade expectations or abstract drill work?

### 3. Text, talk, and task quality
...
- Are multimodal participation paths built in?
- Are directions, visuals, and pacing appropriate?
- Are examples, names, text choices, and family-facing assumptions inclusive?

## Current Known Review Debt
...
At this stage, reviewers should expect the kindergarten set to remain:
